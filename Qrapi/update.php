...
$con = mysqli_connect("localhost", "id6307319_qr","qr123","id6307319_qr");
	...
	$query = "UPDATE `resume` SET  `cid` = (SELECT cid FROM `category` WHERE cname = '$cname'), `filepath` = '$filepath', `examstatus` = '0', `qrstatus` = '0', `applystatus` = '1', `marks` = '0' WHERE `resume`.`lid` = '$lid'";
